...
namespace JobPortal.Models
{
    public class PARAM_USER
    {
        ...
        public Int32 PW_DEFAULT_VAL { get; set; }
        public string PW_RESTRICTED { get; set; }
        public Int32 PW_AGE_HIST { get; set; }
        public Int32 PW_AGE_LOCK { get; set; }
        public Int32 PW_EXPIRY_MAIL { get; set; }
        public Int32 PW_RESET_FORCE { get; set; }
        public Int32 PW_POLICY { get; set; }
        public Int32 LOGIN_TRY_ALLOW { get; set; }
        public DateTime? LOGIN_START_DATE { get; set; }
        public DateTime? LOGIN_END_DATE { get; set; }
        public DateTime? LOGIN_START_TIME { get; set; }
    ...
    [Table("PARAM_USER")]
    public class _PARAM_USER
    {
        public _PARAM_USER()
        {
        }

        public _PARAM_USER(bool setDefaultValue)
        {
            CODE_COMP = 0;
            CODE_ORG = 0;
            FLAG_JobPortal = 0;
